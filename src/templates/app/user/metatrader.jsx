...
const TypeGroup = ({ title, content, types }) => (
    <div className='type-group gr-row'>
        ...
        {types.map((box, i) => (
            <div key={i} className={box.title ? 'gr-6' : 'gr-3 gr-6-p gr-6-m gr-centered'}>
                <div id="box.id || 'rbtn_' _ box.type" className='mt5_type_box' data-acc-type={box.type}>
                    {box.title ?
                        <div>{box.title}</div>
                        :
                        <img src={it.url_for(`images/pages/metatrader/icons/acc_${box.desc.lower}.svg`)} />
                    }
                </div>
                        ...
                        <div id='mv_new_account'>
                            <div id='view_1' className='center-text'>
                                ...
                                <div className='step-2 invisible'>
                                    ...
                                    <TypeGroup title={it.L('Step 2 : Choose types of accounts')} types={[{ type: 'template', desc: 'Cent' }]} >
                            ...
                            <div id='view_2' className='gr-row invisible'>
                                <div className='gr-8 gr-12-m'>
                                    ...
                                    <SubmitButton no_wrapper text={it.L('Create Account')} type='submit' attributes='action="new_account"'
                                        custom_btn_text={it.L('Back')} custom_btn_id='btn_back' custom_btn_className='button-secondary' />
                                </div>
                            </div>
                        </div>
                    </form>
                                ...
                                <div className='gr-6 gr-12-m flex'>
                                    <div className='mt-panel mt-container'>
                                        <form id='frm_deposit'>
                                            ...
                                            <div className='form'>
                                                <FormRow is_two_rows type='text' id='txt_amount_deposit' label={it.L('Amount')} attributes={{ axLength: 10 }} />
